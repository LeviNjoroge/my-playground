...
<?php
    ...
    $nth = $a+$d*($n-1) || $nth-$d*($n-1);
    $n = ($d!=0)? ($nth - $a)/$d + 1 || $n : $n || 0;
    $gen_s = ($n*(2*$a + $d*($n - 1)))/2 || $n*($a+$nth)/2;

    echo "The nth term of the AP is: $nth <br>";
    echo "The number of terms in the AP is: $n <br>";
    echo "The sum of $n terms in the AP is: $gen_s <br>";
?>